export const DEWEY_SECOND_SUMMARY = [
  ...
  ["700", "The Arts"], ["710", "Landscaping & area planning"], ["720", "Architecture"], ["730", "Sculpture, ceramics & metalwork"], ["740", "Drawing & decorative arts"], ["750", "Painting"], ["760", "Graphic arts"], ["770", "Photography & computer art"], ["780", "Music"], ["790", "Sports, games & entertainment"],
  ...
  ["900", "Geography & History"], ["910", "Geography & travel"], ["920", "Biography & genealogy"], ["930", "History of ancient world (to ca. 499)"], ["940", "History of Europe"], ["950", "History of Asia"], ["960", "History of Africa"], ["970", "History of North America"], ["980", "History of South America"], ["990", "History of other areas"],
] as const;
...
export const DEWEY_MAIN_CATEGORIES = [
  { code: "000", name: "Generalities", range: "000-099" },
  { code: "100", name: "Philosophy", range: "100-199" },
  { code: "200", name: "Religion", range: "200-299" },
  { code: "300", name: "Social Science", range: "300-399" },
  { code: "400", name: "Language", range: "400-499" },
  { code: "500", name: "Natural Science", range: "500-599" },
  { code: "600", name: "Technology", range: "600-699" },
  { code: "700", name: "The Arts", range: "700-799" },
  { code: "800", name: "Literature", range: "800-899" },
  { code: "900", name: "Geography & History", range: "900-999" },
] as const;
...
export function mainCategoryForCode(code?: string) {
  if (!code) return null;
  const mainCode = `${code.slice(0, 1)}00`;
  return DEWEY_MAIN_CATEGORIES.find((category) => category.code === mainCode) || null;
}

export function categoryCodeForId(categoryId: string | undefined, categories: Array<{ id: string; name: string }>) {
  const category = categories.find((item) => item.id === categoryId);
  return category?.name.slice(0, 3) || "";
}
